...
const RealtimeChartsComponent: React.FC<Props> = ({ data, targetWob, targetRpm }) => {
  // Reduce data points for rendering performance
...
export const RealtimeCharts = React.memo(RealtimeChartsComponent);
